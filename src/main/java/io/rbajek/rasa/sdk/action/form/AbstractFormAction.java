...
import io.rbajek.rasa.sdk.action.form.slot.mapper.AbstractSlotMapping;
import io.rbajek.rasa.sdk.action.form.slot.mapper.EntitySlotMapping;
import io.rbajek.rasa.sdk.action.form.slot.mapper.IntentSlotMapping;
import io.rbajek.rasa.sdk.action.form.slot.mapper.TriggerIntentSlotMapping;
...
import io.rbajek.rasa.sdk.util.SerializationUtils;
...
public abstract class AbstractFormAction implements Action {
    ...
    /**
     * <p></p>A Map to mapping required slots.</p>
     *
     * <ul>Options:
