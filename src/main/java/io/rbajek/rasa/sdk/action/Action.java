package io.rbajek.rasa.sdk.action;
...
public interface Action {
     ...
     * @param tracker the state tracker for the current user. You can access slot values using {@link Tracker#getSlots()} (tracker,getSlots().get(slotName)),
     *                the most recent user message is {@link Tracker#getLatestMessage()} (tracker.getLatestMessage().getText()) and any other property.
